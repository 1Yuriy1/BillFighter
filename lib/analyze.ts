 ...
 * a parsed extraction.
 */
function resolveField(extracted: ExtractedDocument, field: string): FieldLookup {
...
/**
 * A value that can support a finding: present and not empty. Numbers count
 * even at 0 (a stated $0 is a fact), booleans count even when false (a stated
 * "not emergency" is a fact), but null, empty strings, and empty arrays
 * support nothing.
 */
